...
- 임베디드 시스템 개발, 빅데이터 & 딥러닝(스마트팩토리), 오픈소스 분야에 대한 관심으로 프로젝트 진행 및 학습 중
- 1인 기업(법인)으로 펌웨어 개발 용역 및 컨설턴트업 수행 중
...
- 2013년
  ...
  - 케이블망을 이용한 인터넷 서비스
    - 베트남 CMC Group (베트남 하노이 케이블 방송국에서의 인터넷 서비스) 입찰 제안서 작성 및 입찰 수행
    - KT 주관
