...
- 논문
  - 공학 석사 학위 논문 - 페트리 네트를 이용한 필드버스 시스템의 성능해석
...
- 2020년  
  ...
  - [제조 데이터 분석 기반 스마트공장 구축 지원 사업 - 중기부](https://www.smart-factory.kr/pblanc/readUser/2019-N-0035?page=5)
    - 스마트팩토리 제조 데이터 분석 사업(전담기관 : KAIST & 스마트팩토리데이터협회)
    - OO금속(수요기업), 스파이어테크놀로지(공급기업)
    - 2020/02 ~ 현재
...
- 2015년
  ...
  - [SW 마에스트로 5기 과정 서면평가](/Document/Gmail%20-%20%5BSoMa%5D5기%20SW%20Maestro%20과정%20서면평가%20안내.pdf)
    - 2014년도 SW 마에스트로 과정에 참여하기 위해 신청자에 대한 프로필과 코딩능력 평가
    - 총 674명 접수자 중 67명 블라인드 평가 수행  
...
- 1995년
  - 최대수요전력감시 제어기 개발 - 기인시스템
    * 에너지관리공단 전력 수요관리 과제 수행 (전력수요관리 국내 최초 프로젝트)
    * 최대전력수요제어기(Demand Controller) 개발 (국내 최초) 
    * 카메라로 전력량계 비전분석을 이용한 전력량 측정
    * 전화 모뎀을 이용한 다수의 Demand Controller 연동
    * 1997년까지 전자식 전력량계에서 전력량 pulse를 open 하는 기능을 포함한 KS 인증 
...
- 1993년
  - 삼성전자 하드디스크 검수 시스템 - 강원대학교
    ...
    * MS-DOS상에서 ASCII 코드를 이용한 그래픽적 모니터링 시스템 구현 
